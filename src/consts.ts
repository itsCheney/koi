...
import authorAvatarImage from "./assets/profile.jpg";
...
// 网站名称
export const SITE_TITLE = '寧々の自留地';

// 网站的副标题
export const SITE_DESCRIPTION = '失恋ソング沢山聴いて';

// 博主的昵称
export const SITE_AUTHOR_NAME = "马希罗";

// 博主的头像
export const SITE_AUTHOR_AVATAR = authorAvatarImage;

// 网站版权起始年份
export const SITE_COPYRIGHT_YEAR_START = "???";
...
export const SITE_MENU: { title: string, href: string, target: string }[] = [
    ...
    { title: "标签", href: "./page/tags/", target: "" },
